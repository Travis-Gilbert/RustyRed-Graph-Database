...
impl RustyredState {
    ...
    pub fn graph(&self) -> (Vec<RustyredNode>, Vec<RustyredEdge>) {
...
impl StepState {
    pub fn node(&self, run_id: &str) -> RustyredNode {
        RustyredNode {
